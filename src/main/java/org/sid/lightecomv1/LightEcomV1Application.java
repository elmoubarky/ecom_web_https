...
public class LightEcomV1Application implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        categoryRepository.save(new Category(null,"Photographie",null,null,null));
        categoryRepository.save(new Category(null,"Automobile",null,null,null));
        categoryRepository.save(new Category(null,"House",null,null,null));
        categoryRepository.save(new Category(null,"Sports",null,null,null));
